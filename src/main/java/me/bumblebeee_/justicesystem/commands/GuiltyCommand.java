...
public class GuiltyCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String lbl, String[] args) {
        if (cmd.getName().equalsIgnoreCase("guilty")) {
            ...
            court.setGuilty(true);
            Bukkit.getServer().broadcastMessage(msgs.getMessage("setGuilty").replace("%name%", court.getTarget().getName()));
            return true;
        }
        return false;
    }
